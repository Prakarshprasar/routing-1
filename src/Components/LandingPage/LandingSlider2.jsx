...
<div className={style.sl2flex}>
    <button onClick={decreasecount}  className={count===0?style.hidebtn:style.showbtn}><i className="fa-solid fa-backward"></i></button>
    ...
    <button onClick={increasecount} disabled={count===2}  className={style.showbtn}><i className="fa-solid fa-forward"></i></button>
</div>
)
}
