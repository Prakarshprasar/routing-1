...
const Landingslider1 = () => {
  ...
  return (
    ...
    <div className={style.sl1flex}>
        <button onClick={decreasecount} disabled={count===0}  className={count===0?style.hidebtn:style.showbtn}><i className="fa-solid fa-backward"></i></button>
        ...
        <button onClick={increasecount} disabled={count===2}  className={count===2?style.hidebtn:style.showbtn}><i className="fa-solid fa-forward"></i></button>
    </div>
    </div>
  )
}
